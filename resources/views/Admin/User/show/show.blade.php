                                    ...
                                    <path
                                        ...
                                        <a href="javascript:void($this);"
                                           class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            ...
                                            <!--end::Svg Icon-->{{trans('lang.user_application')}}</a>
                                        <a href="javascript:void($this);"
                                           class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            ...
                                            <!--end::Svg Icon-->{{trans('lang.'.$data->location)}}</a>
                                        <a href="javascript:void($this);"
                                ...
                                <div class="d-flex my-4">
                                    ...
                                    <div
                                        ...
                                        <input
                                            ...
                                            onchange="update_active(this,'{{route($route.'.change_active')}}')"
