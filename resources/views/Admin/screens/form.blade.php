...
<div class="fv-row mb-7">
    <!--begin::Label-->
    <label class="required fw-bold fs-6 mb-2">{{__('lang.body_ar')}}</label>
    <!--end::Label-->
    <!--begin::Input-->
    <input type="text" name="body_ar"
           class="form-control form-control-solid mb-3 mb-lg-0"
           placeholder="" value="{{old('body_ar',$data->body_ar ?? '')}}" required/>
    <!--end::Input-->
</div>
<div class="fv-row mb-7">
    <!--begin::Label-->
    <label class="required fw-bold fs-6 mb-2">{{__('lang.body_en')}}</label>
    <!--end::Label-->
    <!--begin::Input-->
    <input type="text" name="body_en"
           class="form-control form-control-solid mb-3 mb-lg-0"
           placeholder="" value="{{old('body_en',$data->body_en ?? '')}}" required/>
    <!--end::Input-->
</div>
