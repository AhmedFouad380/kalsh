                                ...
                                <div class="tab-pane fade" id="kt_aside_nav_tab_projects" role="tabpanel">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex mb-10">
                                                    ...
                                                    <div data-kt-search-element="wrapper">
                                                                ...
                                                                <a href="#"
                                                                   class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                                    ...
                                                                    <div
                                                                        class="d-flex flex-column justify-content-start fw-bold">
                                                                        <span
                                                                            class="fs-6 fw-bold">Company Rbranding</span>
                                                                        <span
                                                                ...
                                                                <a href="#"
                                                                   class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                                    ...
                                                                    <div
                                                                        class="d-flex flex-column justify-content-start fw-bold">
                                                                        <span
                                                                            class="fs-6 fw-bold">EcoLeaf App Launch</span>
                                                                        <span
                                                        ...
                                                        <div class="mb-4" data-kt-search-element="main">
                                                            ...
                                                            <div class="d-flex flex-stack fw-bold mb-5">
                                                                <!--begin::Label-->
                                                                <span
                                                                    class="text-muted fs-6 me-2">Recently Searched</span>
                                                                <!--end::Label-->
                                                                <!--begin::Toolbar-->
                                            ...
                                            <div class="flex-shrink-0 ms-2">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                     data-kt-menu="true" id="kt_menu_61bc5232062c0">
                                                    <!--begin::Header-->
                                                    <div class="px-7 py-5">
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <div>
                                                                <select class="form-select form-select-solid"
                                                                        ...
                                                                        data-dropdown-parent="#kt_menu_61bc5232062c0"
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="mb-10">
                                                <!--begin::Item-->
                                                <a href="../../demo7/dist/apps/projects/project.html"
                                                   class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Briviba
                                                            SaaS</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                ...
                                                <a href="../../demo7/dist/apps/projects/project.html"
                                                   class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Vine
                                                            Quick Reports</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                ...
                                                <a href="../../demo7/dist/apps/projects/project.html"
                                                   class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Baloon
                                                            SaaS</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                ...
                                                <a href="../../demo7/dist/apps/projects/project.html"
                                                   class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Most
                                                            Cloudy UMC</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                ...
                                                <a href="../../demo7/dist/apps/projects/project.html"
                                                   class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Disqus
                                                            Forum</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                ...
                                                <a href="../../demo7/dist/apps/projects/project.html"
                                                   class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Proove
                                                            Quick CRM</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                ...
                                <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <div class="text-center pt-10 mb-20">
                                            ...
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <p class="text-gray-400 fs-4 fw-bold mb-10">There are no customers added
                                                yet.
                                        ...
                                        <div class="text-center px-4">
                                            <img src="assets/media/illustrations/sigma-1/18.png" alt=""
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <div class="mb-12">
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="../../demo7/dist/pages/profile/overview.html"
                                                       class="text-gray-800 text-hover-primary fs-6 fw-bold">HTML, CSS
                                                        Coding</a>
                                                    <span class="text-muted fw-bold">Art Director</span>
                                                </div>
                                                <!--end::Text-->
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <div class="mb-12">
                                            ...
                                            <div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
                                                ...
                                                <div class="flex-grow-1 me-2">
                                                    <a href="../../demo7/dist/widgets/lists.html"
                                                       class="fw-bolder text-gray-800 text-hover-primary fs-6">Air B
                                                        &amp; B - Real Estate</a>
                                            ...
                                            <div class="d-flex align-items-center bg-light-primary rounded p-5 mb-7">
                                                ...
                                                <div class="flex-grow-1 me-2">
                                                    <a href="../../demo7/dist/widgets/lists.html"
                                                       class="fw-bolder text-gray-800 text-hover-primary fs-6">B &amp; Q
                                                        - Food Company</a>
                                        ...
                                        <div class="mb-12">
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <span
                                                        class="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Item-->
                            ...
                            <div class="tab-content rounded h-100 bg-light p-10">
                                ...
                                <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-bold fs-5 text-gray-700 flex-grow-1">Up to 10 Active Users</span>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="fw-bold fs-5 text-muted flex-grow-1">Unlimited Cloud Space</span>
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen040.svg-->
                                            <span class="svg-icon svg-icon-1">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                             viewBox="0 0 24 24" fill="none">
                                ...
                                <div class="tab-pane fade" id="kt_upgrade_plan_advanced">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-bold fs-5 text-gray-700 flex-grow-1">Accounting Module</span>
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
                                            <span class="svg-icon svg-icon-1 svg-icon-success">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                             viewBox="0 0 24 24" fill="none">
                                ...
                                <div class="tab-pane fade" id="kt_upgrade_plan_enterprise">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="fw-bold fs-5 text-gray-700 flex-grow-1">Unlimited Cloud Space</span>
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
                                            <span class="svg-icon svg-icon-1 svg-icon-success">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                             viewBox="0 0 24 24" fill="none">
                                            ...
                                            <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <!--begin:Info-->
															<span class="d-flex flex-column">
																<span
                                                                    class="fw-bolder fs-6">Face to Face Discussions</span>
                                            ...
                                            <span class="d-flex align-items-center me-2">
                                                ...
                                                <!--begin::Info-->
														<span class="d-flex flex-column">
															...
															<span
                                                                class="fs-7 text-muted">Amazon Fast NoSQL Database</span>
														</span>
                                                <!--end::Info-->
													</span>
                                            <!--end::Label-->
