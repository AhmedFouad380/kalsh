...
use App\Http\Requests\Dashboard\ImportantNumberRequest;
...
{
    protected $viewPath = 'Admin.important_numbers.';
    private $route = 'important_numbers';

    public function __construct(ImportantNumber $model)
    {
    ...
    public function datatable(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('actions', function ($row) {
                $actions = ' <a href="' . url($this->route . "/edit/" . $row->id) . '" class="btn btn-active-light-info">Edit <i class="bi bi-pencil-fill"></i>  </a>';
                return $actions;
    ...
    public function store(ImportantNumberRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ImportantNumberRequest $request)
    {
        $data = $request->validated();
